...
CREATE TABLE Sessions (
    ...
    FOREIGN KEY (event_id) REFERENCES Events_users(event_id)
);
...
INSERT INTO Events_users ( title, description, city, start_date, end_date, status, organizer_id) VALUES
...
(1, 'image', 'https://portal.com/resources/ai_poster.jpg', '2025-04-20 09:00:00'),
